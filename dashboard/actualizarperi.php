...
$sql="SELECT * FROM periodo WHERE id_per_aca='$id_per_aca'";
    ...
    <body>
        <body style="background-color:#f1f1f1;">
            <img src="http://1.bp.blogspot.com/-7Z1AXu6m1qk/VZ1aYZht_FI/AAAAAAAAADM/71nPaZw9KeM/s1600/fce11d3e-05be-425e-b540-56f856b2c7ef.gif"width="150" height="150">
                ...
                <form action="updateperi.php" method="POST">

<input type="hidden" name="id_per_aca" value="<?php echo $row['id_per_aca']  ?>">
                            
<input type="text" class="form-control mb-3" name="nom_per" placeholder="Nombre Periodo" style="border: 3px solid; color: #000000;"value="<?php echo $row['nom_per']?>">                             

                            <input type="submit" class="btn btn-primary btn-block" value="Actualizar">
                    </form>
                    <th><label for="busqueda"></label><br><a href="periodo.php" class="btn btn-primary btn-block">VOLVER</a></th>
