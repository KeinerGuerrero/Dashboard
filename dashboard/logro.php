...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="ingresarlogro.php" class="boton_1" ><style type="text/css">
  .boton_1{
             ...
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                                    <tr>
                                        ...
                                        <td style="font-family:initial; font-size: 9">Nombre logro</td>
                                        <td style="font-family:initial; font-size: 9">Periodo</td>
                                        <td style="font-family:initial; font-size: 9">Año Academico</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_logro']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['per_logro']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_ano_esc']?></FONT></td>
                                                <th style="font-family:monospace; font-size: 10",color:darkred><a href="actualizarlogro.php?id_logro=<?php echo $row['id_logro'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:monospace; font-size: 10",color:skyblue><a href="eliminarlogro.php?id_logro=<?php echo $row['id_logro'] ?>" class="btn btn-danger">Eliminar</a></th>  
                                             </tr>                                         
