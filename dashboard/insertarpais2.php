...
<!-- <div class="col-md-5" style="align-content: right;">
 ...
 <form action="insertarpais.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb3" name="id_pais" placeholder="ID"style="border: 3px solid; color: black;"><br>
                                    <input type="text" class="form-control mb3" name="nom_pais" placeholder="Nombre Pais"style="border: 3px solid; color: black;"><br>
