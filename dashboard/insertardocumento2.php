...
<!-- <div class="col-md-5" style="align-content: right;">
 ...
 <form action="insertardoc2.php" method="POST">
                                    <input type="text" class="form-control mb-3" name="tipo_doc" placeholder="Tipo Documento"style="border: 3px solid; color: black;">
                                    <input type="text" class="form-control mb-3" name="nom_doc" placeholder="Nombre Documento"style="border: 3px solid; color: black;">
