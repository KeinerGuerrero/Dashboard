...
<!-- <div class="col-md-5" style="align-content: right;">
 ...
 <form action="insertarperi.php" method="POST">

                                    <input type="text" class="form-control mb3" name="id_per_aca" placeholder="ID"style="border: 3px solid; color: black;"><br>
                                    <input type="text" class="form-control mb3" name="nom_per" placeholder="Nombre Perido"style="border: 3px solid; color: black;"><br>
